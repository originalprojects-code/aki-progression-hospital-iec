# Modeling scope and reporting limits
...
- Decision-curve analysis estimates net benefit and does not establish improved patient outcomes.
- Renal-marker ablation is post-hoc and exploratory.
- No probability threshold is presented as universally optimal.
- Independent external validation and prospective clinical-impact evaluation remain necessary.
